(() => {
  if (!document.querySelector('link[href^="orderpro-preview.css"]')) {
    ...
    link.rel = 'stylesheet';
    link.href = 'orderpro-preview.css?v=20260828-1';
  ...
  section.innerHTML = `
    <div class="orderpro-live-head">
      ...
      <p>
        ORDERPRO is the synthetic brownfield workload behind CHG-0042. Reproduce the old behavior, apply the requested customer-facing change, and then watch the operational collision appear before moving to the ChangeProof remediation.
      </p>
    </div>

    <div class="orderpro-frame-shell">
      <div class="orderpro-frame-bar">
        <div><i></i><i></i><i></i><b>ORDERPRO / Enterprise Order Management</b></div>
    ...
    <div class="scenario-hint">
      <b>Suggested path:</b> leave the defaults at <code>Hartwell / Preferred / Expedited / 17:00</code>, submit once in each lifecycle state, then open the evidence sessions.
    </div>
